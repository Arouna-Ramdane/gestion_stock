...
@section('content')
    <div class="max-w-xl mx-auto mt-10 bg-white shadow-md rounded-xl p-8 justify-center">
        ...
        <form action="{{ route('users.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                <input type="text" name="first_name" value="{{ old('first_name') }}" required required placeholder="Nom"
            ...
            <div>
                <input type="text" name="name" value="{{ old('name') }}" required required placeholder="Prenom"
                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring focus:ring-blue-200">
            </div>

            <div>
                <input type="tel" name="contact" value="{{ old('contact') }}" required required placeholder="contact"
                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring focus:ring-blue-200">
            ...
            <div>
                <input type="email" name="email" value="{{ old('email') }}" required required placeholder="email"
                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring focus:ring-blue-200">
            ...
            <div>
                <input type="text" name="adresse" value="{{ old('adresse') }}" required required placeholder="Adresse"
                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring focus:ring-blue-200">
            </div>

            <div>

                <input type="password" name="password" value="{{ old('password') }}" required placeholder="Mot de passe"
                class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring focus:ring-blue-200">
            </div>
